...
(function() {
  ...
  this.VKI_layout['\u{12A0}\u{121B}\u{122D}\u{129B}'] = { // Do not forget the dead key definitions for Ethiopic below. Dead keys checkbox must be active (recommended turned on by default).
    'name': "Amharic", 'keys': [
  ...
  this.VKI_layout['Suisse Fran\u00e7ais'] = {
